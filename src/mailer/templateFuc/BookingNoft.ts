  ...
  return `
        <div>
            <p style="font-size: 14px; line-height: 22px;">
                ...
                both you and your anonymous peer:<br><br>
                <b>Punctuality</b>: Please arrive at least 5 minutes before your scheduled interview time. This allows you to check your setup and ensures a timely start.<br><br>
                <b>Respectfulness</b>: The golden rule of our platform is respect. Please be courteous and professional throughout your interaction with your peer.<br><br>
                ...
                This courtesy allows us to offer the slot to another member eager for practice.<br><br>
                Preparing for Your Session:<br><br>
                ...
                practice.<br><br>
                Remember, the identity of your peer will be revealed only at the time of the interview, fostering an unbiased and focused practice environment.<br><br>
                We're here to support you in your journey to interview excellence. If you have any questions or need assistance, our support team is just a message away.<br><br>
